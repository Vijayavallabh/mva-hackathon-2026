...
Participant jvv7 · research draft 10 · 2026-09-19
...
The v10 release binds the revised report, ledger, validation plan, pitch, slide deck
and falsification review, plus the search plans and scripts. V1 through v9 remain
preserved. Narration and visible slide content remain those of v9; current-use links
point to v10. The new hypotheses and detailed safeguards are in the full protocol.
Checks establish content integrity and declared invariants, not scientific truth,
clinical efficacy or upload readiness.
