...
Participant jvv7 · research draft 13 · 2026-09-21
...
the missense allele is discordant and limited by failed experimental-control checks.
...
Accordingly, this revision withdraws v12's unqualified statement that computational
evidence supports the missense allele. The new comparisons do not overturn the
...
Evo2 7B and 40B passed fixed numerical checks and the same 96-variant public BRCA1
functional benchmark (descriptive AUROCs 0.942 and 0.920). Both report-derived
...
phase or drug response, and does not resolve the protein-model control limitations.
...
This v13 report adds the owner-hosted model comparison and corrects the overbroad
missense-evidence statement in v12. The v10 drug ledger and validation decisions
remain unchanged. Every previous release, including v12 and its bound inputs, is
preserved. The [model comparison](https://github.com/Vijayavallabh/mva-hackathon-2026/blob/main/notes/track2-model-expansion.md) records plans, complete
results, failed controls, runtime issues, commands and disclosure. Local validation
checks establish provenance and declared invariants, not clinical validity.

The new [eight-page v13 slides](https://github.com/Vijayavallabh/mva-hackathon-2026/blob/main/notes/track2-slides-v13.html), [aligned script](https://github.com/Vijayavallabh/mva-hackathon-2026/blob/main/notes/track2-pitch-v13.md)
and [video description](https://github.com/Vijayavallabh/mva-hackathon-2026/blob/main/notes/track2-video-description-v13.md) incorporate the model comparison
and expanded disclosure. Earlier presentations remain preserved. Include the full
acknowledgement page inside the three-minute video. Recording, hosting, owner review,
live authenticated checks and a receipt remain open; no upload occurred here.

The portal requires a PDF or Markdown report with participant/team identity in its
filename, a GitHub URL and the video link. Use a newly reviewed participant-named report; the preserved v12 package does not contain these new findings.
...
remain in the evidence rather than selecting only favorable outputs.
...
retrieval failures, model identity and contradictory evidence. Expanded protein-model comparisons retain discordance and
failed controls; confident structures do not validate allele function. No new biological
