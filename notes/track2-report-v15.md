...
Participant jvv7 · research draft 15 · 2026-09-24
...
The [nine-page v15 slides](https://github.com/Vijayavallabh/mva-hackathon-2026/blob/main/notes/track2-slides-v15.html), [aligned read-aloud transcript](https://github.com/Vijayavallabh/mva-hackathon-2026/blob/main/notes/track2-pitch-v15.md)
and [video description](https://github.com/Vijayavallabh/mva-hackathon-2026/blob/main/notes/track2-video-description-v15.md) integrate these findings
...
control successes are reported alongside the earlier failures; confidence still does
not qualify a functional or drug-rescue claim.
...
retrieval failures, model identity and contradictory evidence. Newer ESMC/ESM3 comparisons pass a small fixed control challenge and strengthen the
computational reason to test the missense allele. Earlier discordance and failed
controls remain visible; confident structures do not validate allele function. No new biological
