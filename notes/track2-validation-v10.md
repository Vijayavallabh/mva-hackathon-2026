# Track 2 v10: validation plan and decision rules
...
The [v10 report](https://github.com/Vijayavallabh/mva-hackathon-2026/blob/main/notes/track2-report-v10.md) and revised
[claim/decision ledger](https://github.com/Vijayavallabh/mva-hackathon-2026/blob/main/notes/track2-evidence-v10.json) set the evidence boundaries.
...
another disease model. The unreviewed dose/schedule supplement must be checked before
using the Balnis experiment to inform a dosing design.
