# Track 2 v17 — video description draft

Use this text with the final recorded three-minute video. It is not a hosted URL,
receipt or readiness attestation. Keep the full acknowledgement inside the video too.

## Description to accompany the video

Rare Disease, Real Kid: The MVA Hackathon 2026 · Track 2 · jvv7.

Can everolimus improve useful cell function in BUB1B-associated MVA? We propose a
qualified test of this approved mTORC1 inhibitor, with genotype-aware controls,
complete cell-fate accounting, independent confirmation and explicit stopping rules.
The mechanism is conditional; no drug earns rescue priority, no wet-lab experiment
has been performed, and phase, endogenous effects and clinical exposure remain unresolved.
This is a hypothesis for investigation, not a treatment recommendation.

Report: https://github.com/Vijayavallabh/mva-hackathon-2026/blob/main/notes/track2-report-v17.md
Slides: https://github.com/Vijayavallabh/mva-hackathon-2026/blob/main/notes/track2-slides-v17.html
Reproduction: https://github.com/Vijayavallabh/mva-hackathon-2026/blob/main/notes/track2-reviewer-guide-v17.md
Code: https://github.com/Vijayavallabh/mva-hackathon-2026

The pitch omits historical AF3/Atlas numerical outputs and derived figures. Historical
research retains its terms/notices; this does not establish that the linked history
is outside the challenge's CC BY scope. Provider settings and distribution scope remain
open owner-review items; no blanket licence or resolved eligibility is asserted.
