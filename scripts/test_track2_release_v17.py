...
class V17ReleaseTests(unittest.TestCase):
    ...
    def test_current_presentation_and_exports(self):
        ...
        self.assertEqual((r['slides'], r['narration_words'], r['exports']['report_pages']), (8,342,7))
    ...
    def test_manifest_never_attests_unknown_terms_or_delivery(self):
        ...
        m.update(schema_version=17,created_utc='2026-09-24T00:00:00+00:00',phase='unconfirmed',
