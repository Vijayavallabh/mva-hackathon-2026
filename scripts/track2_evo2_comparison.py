#!/usr/bin/env python3
"""Fixed Evo2 numerical qualification, public BRCA1 benchmark and candidate diagnostics."""
...
def run(name,out):
    ...
    if name not in ['evo2_7b','evo2_40b']:raise ValueError('Unregistered model')
    ...
    env=ROOT/('evo2-fp8-env' if name=='evo2_40b' else 'evo2-env')
    ...
    mean_loss=float(np.mean(losses));expected={'evo2_7b':0.3476563,'evo2_40b':0.2159424}[name]
